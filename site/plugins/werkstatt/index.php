      ...
      'membercount' => [
        ...
        'html' => function ($tag) {
          ...
          if ($cachedData === null) {
            ...
            $apiUrl = option('welcome-werkstatt.werkstatt.easyverein.apiBaseUrl') . 'member/?memberGroups=' . option('welcome-werkstatt.werkstatt.easyverein.activeMembersGroupId');
